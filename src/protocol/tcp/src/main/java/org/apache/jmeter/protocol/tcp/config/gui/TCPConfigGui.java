...
public class TCPConfigGui extends AbstractConfigGui {
    ...
    private JPanel createRequestPanel() {
        String name=JMeterUtils.getResString("tcp_request_data");
        JLabel reqLabel = new JLabel(name); // $NON-NLS-1$
//        JLabel reqLabel = new JLabel(JMeterUtils.getResString("english_look")); // $NON-NLS-1$
